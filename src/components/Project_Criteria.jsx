...
const Project_Criteria = () => {
  ...
  const handleAddButtonClick = () => {
    ...
    axios
      .post(`${API_BASE_URL}/api/Project_Criteria/Hobby/Create`, data, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      })
  ...
  const fetchData = async () => {
    ...
    try {
      const response = await axios.get(
        `${API_BASE_URL}/api/Project_Criteria/Hobby/GetByProjectId?ProjectId=${ProjectId}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
...
const handleDeleteClick = async (projHobbyCriId) => {
    const token = localStorage.getItem("token");
  
    try {
      await axios.delete(
        `${API_BASE_URL}/api/Project_Criteria/Hobby/Delete?hobby_Criteria_Delete_DTO.proj_Hobby_Cri_Id=${projHobbyCriId}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
      ...
      const updatedTrainingList = TrainingData.filter(
        (training) => training.Proj_Hobby_Cri_Id !== projHobbyCriId
      );
  ...
  const handleAddButtonClick1 = () => {
    ...
    const data = {
      Proj_Skill_Cri_Id: Skills_Criteria_Id,
    ...
    if (Skills_Criteria_Id) {
      ...
      axios
        .post(`${API_BASE_URL}/api/Project_Criteria/AddSkills`, data, {
          headers: {
            Authorization: `Bearer ${token}`,
          },
        })
  ...
  const fetchData1 = async () => {
    ...
    try {
      const response = await axios.get(
        `${API_BASE_URL}/api/Project_Criteria/GetSkillsByProjectId?ProjectId=${ProjectId}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
  ...
  const handleUpdateButtonClick = (data) => {
    ...
    axios
      .put(`${API_BASE_URL}/api/Project_Criteria/UpdateSkills`, data, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      })
  ...
  const handleDeleteSkill = async (proj_Skill_Cri_Id) => {
    const token = localStorage.getItem("token");

    try {
      await axios.delete(
        `${API_BASE_URL}/api/Project_Criteria/DeleteSkills?skill_Criteria_Delete_.proj_Skill_Cri_Id=${proj_Skill_Cri_Id	}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
      ...
      const updatedTrainingList = TrainingSkill.filter(
        (training) => training.Proj_Skill_Cri_Id !== proj_Skill_Cri_Id
      );
  ...
  const handleEditButtonClick = (data1) => {
    ...
    setSkills_Criteria_Id(data1.Proj_Skill_Cri_Id);
    showForm2();
  };
  ...
  const [Proj_Qual_Id, setQualification_Criteria_Id] = useState();
  const [
  ...
  const handleEditButtonClick1 = (data2) => {
    ...
    setQualification_Criteria_Id(data2.Proj_Qual_Id);
    showForm3();
  };
  ...
  const handleAddButtonQualification = () => {
    ...
    if (Proj_Qual_Id) {
      ...
      axios
        .post(`${API_BASE_URL}/api/Project_Criteria/AddQual/Create`, data, {
          headers: {
            Authorization: `Bearer ${token}`,
          },
        })
  ...
  const handleUpdateButtonClick1 = (data) => {
    ...
    axios
      .put(`${API_BASE_URL}/api/Project_Criteria/UpdateQual/Update`, data, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      })
  ...
  const fetchData2 = async () => {
    ...
    try {
      const response = await axios.get(
        `${API_BASE_URL}/api/Project_Criteria/GetQualifications?projectId=${ProjectId}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
  ...
  const handleDeleteQualification = async (proj_Qual_Id) => {
    const token = localStorage.getItem("token");

    try {
      await axios.delete(
        `${API_BASE_URL}/api/Project_Criteria/DeleteQual?qual_Criteria_Delete_.proj_Qual_Id=${proj_Qual_Id}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
      ...
      const updatedTrainingList = TrainingQualification.filter(
        (training) => training.Proj_Qual_Id !== proj_Qual_Id
  ...
  const [Proj_Exp_Id, setExperience_Criteria_Id] = useState(null);
  ...
  const handleDeleteExperience = async (proj_Exp_Id) => {
    const token = localStorage.getItem("token");

    try {
      await axios.delete(
        `${API_BASE_URL}/api/Project_Criteria/DeleteExp?exp_Criteria_Delete_.proj_Exp_Id=${proj_Exp_Id}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
      ...
      const updatedTrainingList = TrainingExperience.filter(
        (training) => training.Proj_Exp_Id !== proj_Exp_Id
      );
  ...
  const handleEditButtonClick3 = (data3) => {
    ...
    setExperience_Criteria_Id(data3.Proj_Exp_Id);
    showForm4();
  };
  const handleFormSubmit = () => {
    ...
    if (Proj_Exp_Id) {
      ...
      axios
        .post(`${API_BASE_URL}/api/Project_Criteria/AddExp/Create`, data, {
          headers: {
            Authorization: `Bearer ${token}`,
          },
        })
  ...
  const handleUpdateButtonClick2 = () => {
    ...
    axios
      .put(`${API_BASE_URL}/api/Project_Criteria/UpdateExp/Update`, data, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      })
                                ...
                                <div className="animate">
                                  ...
                                  >
                                    <button
                                      className="remove"
                                      onClick={() =>
                                        handleDeleteSkill(data1.Proj_Skill_Cri_Id)
                                      }
                                    >
                                      Delete
                                      <svg width={16} height={16}>
                                ...
                                <div className="animate">
                                  ...
                                  >
                                    <button
                                      className="remove"
                                      onClick={() =>
                                        handleDeleteQualification(data2.Proj_Qual_Id)
                              ...
                              <div className="animate">
                                ...
                                <span className="hint--top" data-hint="Delete">
                                  <button className="remove" onClick={() =>
                                    handleDeleteExperience(data41.Proj_Exp_Id)
                                  }>
                                    Delete
                                    <svg width={16} height={16}>
                                      <path d="M10.7 2.2c0 .1.1.2.3.2h2.2c.4 0 .7.3.7.7 0 .3-.2.6-.5.7L13 14.2c0 .8-.7 1.5-1.6 1.5H4.6c-.8 0-1.5-.7-1.6-1.5L2.7 3.8c-.3 0-.6-.3-.6-.6 0-.4.3-.7.7-.7H5c.1 0 .2-.1.3-.2l.2-.6C5.7.9 6.4.4 7.2.4h1.6c.8 0 1.5.6 1.7 1.3l.2.5zM7.5 5.7v7c0 .3.2.5.5.5s.5-.2.5-.5v-7c0-.3-.2-.5-.5-.5s-.5.2-.5.5zm-2.4 0l.2 7c0 .3.2.5.5.5s.5-.2.5-.5l-.2-7c0-.3-.2-.5-.5-.5s-.5.3-.5.5zm4.8 0l-.2 7c0 .3.2.5.5.5s.5-.2.5-.5l.2-7c0-.3-.2-.5-.5-.5s-.5.2-.5.5zM6.8 2.4h2.3c.1 0 .1 0 .1-.1L9.1 2c0-.1-.2-.3-.3-.3H7.2c-.1 0-.3.1-.3.3l-.1.4c-.1 0 0 0 0 0z" />
...
export default Project_Criteria
