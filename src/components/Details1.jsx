...
const Details1 = () => {
      ...
      const fetchTrainingCriteria = async () => {
        ...
        try {
          const criteriaResponse = await axios.get(
            `${API_BASE_URL}/api/Training_Criteria/Hobby/GetByTrainingId?trainingId=${Training_Id}`,
            {
              headers: {
        ...
        try {
          const hobbyCriteriaResponse = await axios.get(
            `${API_BASE_URL}/api/Training_Criteria/GetSkillsByTrainingId?trainingId=${Training_Id}`,
            {
              headers: {
                Authorization: `Bearer ${token}`,
              },
        ...
        try {
          const qualificationsResponse = await axios.get(
            `${API_BASE_URL}/api/Training_Criteria/GetQualifications?trainingId=${Training_Id}`,
            {
              headers: {
                Authorization: `Bearer ${token}`,
              },
        ...
        try {
          const expCriteriaResponse = await axios.get(
            `${API_BASE_URL}/api/Training_Criteria/GetExpCriteria?trainingId=${Training_Id}`,
            {
              headers: {
                Authorization: `Bearer ${token}`,
              },
    ...
    //             `${API_BASE_URL}/api/Training_Join/Create`,
    //             {
    ...
    const handleJoinButtonClick = async () => {
      ...
      try {
        ...
        if (error.response && error.response.data && error.response.data.Message) {
          ...
          alert(`Error joining training: ${errorMessage}`);
        } else {
          console.error("Error joining training", error);
        }
      }
            ...
            <div className="onboarding-step professional-info">
              <div id="skills" className="onboarding-field is-required">
                ...
                <div className="field-content">
                  ...
                  <button
                    type="submit"
                    class="color-btn btn btn-secondary me-3 mb-1 "
